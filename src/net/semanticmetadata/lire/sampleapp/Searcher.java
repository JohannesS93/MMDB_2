...
public class Searcher {
    public static ArrayList<String> indexResult (File f) throws IOException {
       ...
       ArrayList<String> paths = new ArrayList<String>();
        ...
        IndexReader ir = DirectoryReader.open(FSDirectory.open(Paths.get("C:/Users/Johannes/workspaceMDB/MMDB/index")));
